      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            <div>
             ...
             <div>
              <label htmlFor="reveal-time" className="block text-lg font-semibold text-gray-800 mb-2 flex items-center gap-2">
                  Reveal Time
                  <Tooltip text="Optional: Set a specific time for the 'Big Reveal'. If left blank, it will happen at midnight." />
              </label>
              <input type="time" id="reveal-time" value={exchangeTime} onChange={e => setExchangeTime(e.target.value)} className="w-full p-2 border border-gray-300 rounded-md"/>
            </div>
            <div>
