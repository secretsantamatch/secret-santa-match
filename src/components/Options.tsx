      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <Tooltip text="This note will appear on each participant's unique link." />
          </div>
          <textarea
              value={eventDetails}
        ...
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <Tooltip text="This is the date the full list of matches will be revealed to everyone. Set it to your party date!" />
          </div>
          <input
            type="date"
            value={exchangeDate}
