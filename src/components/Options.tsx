...
const Options: React.FC<OptionsProps> = ({
  ...
  return (
    <div className="space-y-8">
      <div>
        <label htmlFor="event-details" className="block text-lg font-semibold text-gray-800 mb-2">Event Details (Optional)</label>
        <textarea
          id="event-details"
          rows={3}
          value={eventDetails}
        ...
        />
        <p className="text-sm text-gray-500 mt-1">This info will appear on the shared links and printable cards.</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2">
          ...
          <span className="text-gray-600 font-semibold text-sm">cannot draw</span>
          ...
          <button onClick={handleAddExclusion} className="w-full sm:w-auto bg-slate-700 hover:bg-slate-800 text-white font-bold py-2 px-4 rounded-md whitespace-nowrap">Add Rule</button>
        </div>
       ...
       <div className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2">
          ...
          <span className="text-gray-600 font-semibold text-sm">must draw</span>
          ...
          <button onClick={handleAddAssignment} className="w-full sm:w-auto bg-slate-700 hover:bg-slate-800 text-white font-bold py-2 px-4 rounded-md whitespace-nowrap">Add Rule</button>
        </div>
