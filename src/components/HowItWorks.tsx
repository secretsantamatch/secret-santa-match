                ...
                {steps.map((step, index) => (
                    <React.Fragment key={index}>
                        <button
                            ...
                            className="flex-1 bg-white rounded-2xl p-6 border border-slate-200 shadow-lg text-center flex flex-col items-center justify-center transition-all duration-200 transform hover:-translate-y-1 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-offset-0 focus:ring-[var(--primary-focus-ring-color)]"
                        >
            ...
            <div className="md:hidden space-y-4">
                {steps.map((step) => (
                    <button
                        key={step.id}
                        onClick={() => onStepClick(step.id)}
                        className="w-full bg-white rounded-2xl p-6 border border-slate-200 shadow-lg flex items-center gap-4 text-left transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)]"
                    >
                        <step.Icon />
                        <div>
