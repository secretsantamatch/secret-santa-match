...
interface ParticipantManagerProps {
  ...
  onBulkAddClick: () => void;
  // Fix: Add duplicateNameIds to props to identify and highlight duplicate names.
          ...
          <div key={participant.id} className="grid grid-cols-12 gap-x-4 gap-y-2 items-start animate-fade-in-up" style={{ animationDelay: `${index * 30}ms` }}>
            <div className="col-span-12 sm:col-span-4">
              ...
              <input
                ...
                className={`w-full p-2.5 border rounded-lg focus:ring-2 focus:ring-offset-1 transition ${duplicateNameIds.has(participant.id) ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-300 focus:ring-[var(--primary-focus-ring-color)]'}`}
              />
            </div>
