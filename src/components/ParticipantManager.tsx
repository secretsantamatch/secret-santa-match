    ...
    <div className="space-y-6">
      <div className="hidden sm:grid grid-cols-12 gap-x-4 text-sm font-semibold text-gray-700">
        ...
        <div className="col-span-6 flex items-center gap-1">
            Gift Ideas / Notes
            <Tooltip text="Notes for the gift giver, like wishlist items, clothing sizes, or favorite things. These will appear on their match's link and printable cards." />
        </div>
        <div className="col-span-1 flex items-center gap-1">
            Budget
             <Tooltip text="Set a spending limit for this person's gift. This will appear on their match's link and printable cards." />
        </div>
      </div>
