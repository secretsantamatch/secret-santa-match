            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <nav className="hidden md:flex items-center gap-6">
                        <a href="/" className="font-semibold text-slate-600 hover:text-red-600 transition-colors">Generator</a>
                        ...
                        <a href="/blog.html" className="font-semibold text-slate-600 hover:text-red-600 transition-colors">Blog & Guides</a>
            ...
            {isMenuOpen && (
                <div className="md:hidden bg-white border-t border-slate-200">
                    <nav className="flex flex-col items-center gap-4 py-4">
                        <a href="/" className="font-semibold text-slate-600 hover:text-red-600">Generator</a>
                        ...
                        <a href="/blog.html" className="font-semibold text-slate-600 hover:text-red-600">Blog & Guides</a>
