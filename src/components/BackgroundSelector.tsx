...
const BackgroundSelector: React.FC<BackgroundSelectorProps> = ({
  ...
  const giver = participants.find(p => p.name.trim()) || { id: 'preview-giver', name: 'Giver Name', notes: '', budget: ''};
  const receiver = participants.filter(p => p.name.trim())[1] || { id: 'preview-receiver', name: "Receiver Name", notes: "Loves books, movies, and hiking. Size M.", budget: "25" };
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-slate-50 p-4 sm:p-6 rounded-xl border border-slate-200">
        ...
        <p className="text-sm text-gray-500 mb-4">Hover to preview, then click to select.</p>
